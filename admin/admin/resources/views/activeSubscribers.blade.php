...
@section('title')
    Passion Predict  | ACTIVE SUBSCRIBERS
@endsection
@section('page')
    Active Members
...
@if($persons->category=='Super' || $persons->category=='General')
    <div class="" role="tabpanel" data-example-id="togglable-tabs">
        <ul id="myTab1" class="nav nav-tabs bar_tabs" role="tablist">
            {{-- <li role="presentation" class="active"><a href="#tab_content33" role="tab" id="profile-tabb" data-toggle="tab" aria-controls="profile" aria-expanded="false">Silver Package</a>
            </li> --}}
            <li role="presentation" class="active"><a href="#tab_content11" id="home-tabb" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Mega Package</a>
            </li>
