        ...
        <div class="form-group col-sm-6">
            ...
            <select name="potential" class="form-control">
                ...
                @if($game->gameType=='1')
                    ...
                    @if($game->sure5Odds!='No')<option value="{{$game->sure5OddsTip}}"  @if($game->testimonialValue==$game->sure5OddsTip) selected @endif><b>Mega Tips</b> : {{$game->sure5OddsTip}}</option> @endif
                    ...
                    @if($game->superInvestment!='No')<option value="{{$game->superInvestmentTip}}"   @if($game->testimonialValue==$game->superInvestmentTip) selected @endif><b>Investment Tips</b> : {{$game->superInvestmentTip}}</option> @endif
                @else
                    ...
                    <option value="{{$game->hwin}}" @if($game->testimonialValue==$game->hwin) selected @endif><b>Home Win</b> : {{$game->hwin}}</option>
