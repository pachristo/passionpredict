        ...
        <div class="container-fluid">
            ...
            <div class="form-group col-md-4">
                ...
                <select name="weh" class="form-control">
                    ...
                    <option value="" @if ($game->weh == '') selected @endif>*-*-*-*-*-*-*-*-*-*</option>
                </select>
            </div>
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" name="hwin" class="form-control" value="{{ $game->hwin }}"
                    placeholder="leave blank if nothing">
            </div>
            <div class="form-group col-md-4">
                <label> Under 3.5 GOALS</label>
                <select name="threeFiveGoals" class="form-control">
                    <option value="over 3.5" @if (trim($game->threeFiveGoals) == 'over3.5') selected @endif>Over 3.5 Goals</option>
                    <option value="under 3.5" @if (trim($game->threeFiveGoals) == 'under3.5') selected @endif>Under 3.5 Goals</option>
                    <option value=""  @if (trim($game->threeFiveGoals) == '') selected @endif>*-*-*-*-*-*-*-*-*-*</option>
                </select>
            </div>
