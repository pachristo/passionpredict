                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu" style="background: whitesmoke; -webkit-box-shadow: inset 0px 0px 10px grey;-moz-box-shadow: inset 0px 0px 10px grey;box-shadow: inset 0px 0px 10px grey;">
                                ...
                                @if($blog->status=='Publish')
                                    <li style="cursor: pointer;"><a class="hidethis" href="{{$blog->id}}" id="h{{$blog->id}}">UNPUBLISH THIS</a></li>
                                @else
                                    <li style="cursor: pointer;"><a class="unhidethis" href="{{$blog->id}}" id="h{{$blog->id}}"><span style="color: green;">PUBLISH THIS</span></a></li>
                                @endif

                                <li style="cursor: pointer;">
                                    <a class="blogdelete" href="{{route('/ajaxblogdelete')}}" data-id="{{$blog->id}}">DELETE</a>
                                </li>
                            </ul>
                        </div>
                    </td>
