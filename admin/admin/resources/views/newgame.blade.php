        ...
        <form method="POST" action="{{ route('/loadPrediction') }}" id="predictionForm">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="singleBet" class="form-control"  placeholder="leave blank if nothing">
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="hwin" class="form-control"
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="bankerOfTheDay" class="form-control"
                        placeholder="leave blank if nothing">
                </div>
