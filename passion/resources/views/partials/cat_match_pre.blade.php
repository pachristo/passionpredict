                                            ...
                                            <div class="blog-title-wrap  pl-2" style="padding-top: 0px;">
                                                <h4>
                                                    <a href="{{ url('/blog') }}/{{ $value->slug }}  ">
                                                        ...
                                                        <p class="hideSM mb-0" style="color:#0a2a5e">{{ $value->title }} <span class="text-white btn btn-warning px-2 py-1" style="    height: 25px;
                                                            line-height: 15px;"><small><i class="fa fa-chevron-circle-right"></i> Read More</small></span>
